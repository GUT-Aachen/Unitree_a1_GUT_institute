...
Or you can press the '5' key to switch the FSM from **FixedStand** to **MoveBase**, now you can use /cmd_vel topic to control the robot in normal turtlebot control with teleop keyboard or with navigation stack.
